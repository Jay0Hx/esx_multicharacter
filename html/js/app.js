        ...
        $("[data-charid=1]")
            .html(
                '<div class="character-info">' +
                    '<img src="https://cdn.discordapp.com/attachments/1057294018507190323/1190371100081799299/Logo_Without_Background.png?ex=65a18e7a&is=658f197a&hm=437bd4acad252d25dacdadfae629f8c2484f85039b225c90d34481f41018377e&" alt="Logo" class="character-logo" />' +
                    '<p class="character-info-name"><h1>' +
                    `${translate.name} ` +
                    "</h1><span>" +
                    data.firstname +
                    " " +
