...
-- Put your server logo here | https://alexguirre.github.io/animations-list/
Config.ServerLogo = ""
Config.EnableAnimation = true
Config.AnimationDict = "anim@mp_player_intcelebrationmale@wave"
Config.AnimationSecondary = "wave"
